...
To determine the angle of attack considering \tc{all} \ta{both }pitch angle, $\theta$, and inflow angles, $\phi$, over the blade \tc{length and azimultal distribution, equation} elements, Figs. \ref{fig:ang-111}-\ref{fig:ang-222}
