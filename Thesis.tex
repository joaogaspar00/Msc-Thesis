...
\input{Thesis_LiteratureReview} % file "Thesis_Background.tex"
\clearpage

\input{Thesis_model} % file "Thesis_Implementation.tex"
\clearpage

\input{Thesis_ComputationalMethodology.tex} % file "Thesis_ComputationalMethodology.tex"
\clearpage
...
\bibliographystyle{IEEEtran} % <<<<< SELECT IF USING REFERENCES BY NUMBER (CITATION ORDER)
...
\input{Thesis_Appendix_AerodasModel} % file "Thesis_Appendix_A.tex"
\cleardoublepage
